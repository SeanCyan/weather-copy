    ...
    return (
            <div className="panel">
                ...
                <div className={`card a${this.props.weatherDayOne.icon}`}>
                    <img src={`https://github.com/SeanCyan/React-Weather-App/blob/gh-pages/icons/${this.props.weatherDayOne.icon}.png`} alt={`${this.props.weatherDayOne.description}`} className='card-icon'/>
